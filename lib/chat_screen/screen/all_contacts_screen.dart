            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: _searchBar(
                      textEditController: controller.allUserSearchController,
                                  ...
                                  InkWell(
                                    ...
                                    child: Row(
                                      children: [
                                        const Image(
                                          image:
                                              AssetImage(Assets.imagesAddIcon),
                                          height: 9,
                                          width: 9,
                                        ),
                                        const SizedBox(
                                      ...
                                      if (snapshot.hasData) {
                                        ...
                                        return ListView.separated(
                                          ...
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            UserModel userModel = UserModel.fromJson(querySnapShot.docs[index].data());
                                            return InkWell(
                                              splashFactory:
