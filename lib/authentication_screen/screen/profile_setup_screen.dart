...
class ProfileSetupScreen extends GetView<AuthenticationController> {
        ...
        child: SingleChildScrollView(
          child: GetBuilder<AuthenticationController>(
            builder: (value) => ModalProgressHUD(
              inAsyncCall: controller.shimmerEffectProfileSetup,
              opacity: 0.5,
              color: Colors.white,
      ...
      children: [
        Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                StringConstants.kWelcomeTo,
                style: TextStyleDecoration.s20w400c1C2439,
              ),
              space05(),
              const Text(
                StringConstants.kChatWave,
                style: TextStyleDecoration.s26w600c1C2439,
              ),
              space15(),
              const Text(
                StringConstants.kProfileSetupDescription,
